...
; (function (global, factory) {
    ...
    var jexcel = (function (el, options) {
        ...
        obj.createCellHeader = function (colNumber) {
            ...
            if (obj.options.columns[colNumber].width)
                obj.colgroup[colNumber].setAttribute('width', colWidth);
            if (obj.options.columns[colNumber].class)
                obj.colgroup[colNumber].setAttribute('class', obj.options.columns[colNumber].class);
